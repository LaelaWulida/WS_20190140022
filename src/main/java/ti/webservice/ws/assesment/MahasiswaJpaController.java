...
import ti.webservice.ws.assesment.exceptions.NonexistentEntityException;
import ti.webservice.ws.assesment.exceptions.PreexistingEntityException;
...
public class MahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ti.webservice_ws.assesment_jar_0.0.1-SNAPSHOTPU");
